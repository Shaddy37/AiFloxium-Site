    ...
    <section className="relative py-32 overflow-hidden bg-white dark:bg-black">
      ...
      <div className="relative max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="mt-4 text-lg text-gray-500 dark:text-white max-w-xl mx-auto">
          Connect your existing stack with 250+ powerful integrations. Build automation workflows that actually ship.
        </p>
        <Link href="/contact">
        ...
        <div className="mt-12 overflow-hidden relative pb-2">
          ...
          <div className="flex gap-10 whitespace-nowrap animate-scroll-left">
             {repeatedIcons(ICONS_ROW1, 4).map((src, i) => (
               <div key={i} className="h-16 w-16 flex-shrink-0 rounded-full bg-white dark:bg-gray-300 shadow-md flex items-center justify-center group">
                 <Image src={src} alt="icon" className="h-10 w-10 object-contain grayscale opacity-80 group-hover:opacity-100 group-hover:grayscale-0 transition-all duration-300" width="64" height="64" />
               </div>
             ))}
          </div>
