...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm cursor-pointer group hover:shadow-md transition-all"
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {project.techStack.map((tech) => (
                  <span
                    key={tech}
                    className="text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-md bg-zinc-100 text-zinc-700 border border-transparent"
                  >
                    {tech}
                  </span>
                ))}
