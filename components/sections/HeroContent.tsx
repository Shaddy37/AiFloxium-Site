        ...
        >
          ...
          >
            ...
            <motion.div
              variants={fadeUp}
              custom={0.5}
              className="inline-flex items-center gap-3 md:gap-4 px-4 py-1.5 md:px-5 md:py-2 rounded-lg border border-zinc-800 bg-zinc-950/40 backdrop-blur-md"
            >
        ...
        >
          ...
          <div className="relative flex items-center gap-4 bg-zinc-950 border border-white/20 pl-8 pr-4 py-4 rounded-full backdrop-blur-3xl shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden min-w-[200px]">
            ...
            <div className="flex flex-col items-start">
              <span className="text-[9px] font-black text-zinc-500 tracking-[0.3em] uppercase leading-none mb-1">
                Initiate Protocol
              </span>
