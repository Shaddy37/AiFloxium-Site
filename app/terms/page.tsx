      ...
      <main id="main-content" className="min-h-screen bg-white text-zinc-800 selection:bg-[#7B2CBF] selection:text-zinc-900 pt-40 pb-24 font-inter">
        <div className="container mx-auto px-6 max-w-4xl">
          <nav className="mb-8 flex flex-wrap items-center gap-2 text-[10px] font-semibold text-zinc-500 uppercase tracking-widest relative z-10 font-inter">
            ...
            <span className="text-zinc-900 font-bold">Terms</span>
          </nav>
          
          <h1 className="text-4xl md:text-5xl font-instrument text-zinc-900 mb-8 tracking-tight">Terms of Use</h1>
          
          <div className="prose prose-invert prose-purple max-w-none font-inter font-light">
            <p className="text-zinc-600 text-lg mb-8 leading-relaxed">
              These Terms govern your access to, and usage of all content, products, and services available at <span className="text-zinc-900">https://www.aifloxium.online</span> website (the &quot;Service&quot;) operated by me, <span className="text-zinc-900 font-semibold">Muhammad Shadab Shams</span>, trading as AIFLOXIUM (&quot;I&quot;, &quot;me&quot;, or &quot;my&quot;).
            </p>
            <p className="text-zinc-600 text-lg mb-8 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <p className="text-zinc-500 leading-relaxed">
                If you have any questions about these Terms of Use, please contact me at <span className="text-zinc-900 font-medium">muhammadshadabshams@gmail.com</span> or <span className="text-zinc-900 font-medium">info@aifloxium.online</span>
              </p>
            </section>
