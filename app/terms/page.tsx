        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-invert prose-zinc max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-brand-orange mb-4">Intellectual Property</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-brand-orange mb-4">Third-Party Services</h2>
              <p className="text-white">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-brand-orange mb-4">Accounts</h2>
              <p className="text-white">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-brand-orange mb-4">Links To Other Websites</h2>
              <p className="text-white">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-brand-orange mb-4">Termination</h2>
              <p className="text-white">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-brand-orange mb-4">Disclaimer</h2>
              <p className="text-white">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-brand-orange mb-4">Jurisdiction and Applicable Law</h2>
              <p className="text-white">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-brand-orange mb-4">Changes</h2>
              <p className="text-white">
