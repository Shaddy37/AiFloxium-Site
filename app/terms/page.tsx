      ...
      <main id="main-content" className="min-h-screen bg-[var(--background)] text-black selection:bg-[#7B2CBF]/20 selection:text-black pt-40 pb-24 font-inter">
        <div className="container mx-auto px-6 max-w-4xl relative z-10">
          ...
          <nav className="mb-8 flex flex-wrap items-center gap-2 text-[10px] font-semibold text-black uppercase tracking-widest relative z-10 font-inter">
            ...
            <span className="text-black font-bold">Terms</span>
          </nav>
          
          <h1 className="text-4xl md:text-5xl font-instrument text-black mb-8 tracking-tight">Terms of Use</h1>
          ...
          <div className="prose prose-gray max-w-none font-inter font-light relative z-10 glass-card p-8 md:p-12 rounded-[2rem] border border-black/5 bg-[var(--muted)]">
            <p className="text-black text-lg mb-8 leading-relaxed">
              These Terms govern your access to, and usage of all content, products, and services available at <span className="text-black font-medium">https://www.aifloxium.online</span> website (the &quot;Service&quot;) operated by me, <span className="text-black font-semibold">Muhammad Shadab Shams</span>, trading as AIFLOXIUM (&quot;I&quot;, &quot;me&quot;, or &quot;my&quot;).
            </p>
            <p className="text-black text-lg mb-8 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <p className="text-black leading-relaxed">
                If you have any questions about these Terms of Use, please contact me at <span className="text-black font-medium">muhammadshadabshams@gmail.com</span> or <span className="text-black font-medium">info@aifloxium.online</span>
              </p>
            </section>
