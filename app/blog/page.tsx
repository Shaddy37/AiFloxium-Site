...
export default async function BlogPage() {
  ...
  return (
    <main id="main-content" className="relative bg-white min-h-screen text-zinc-900 selection:bg-[#7B2CBF] selection:text-zinc-900 overflow-x-hidden">
      <script
      ...
      {/* Blog Hero */}
      <section className="pt-40 pb-20 px-6 relative bg-gradient-to-b from-black via-[#0a0608] to-[#0a0608] overflow-hidden rounded-b-[3rem]">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[800px] bg-[#7B2CBF]/5 opacity-80 pointer-events-none" />
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          <nav className="mb-8 flex justify-center items-center gap-2 text-[10px] font-semibold text-white/50 uppercase tracking-widest relative z-10 font-inter">
            ...
            <span className="text-zinc-900 font-bold">Blog</span>
          </nav>

          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.01] border border-zinc-200 mb-8 liquid-glass">
            <span className="w-2 h-2 rounded-full bg-[#E0AAFF] animate-pulse" />
            <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-600">Research & Intelligence</span>
          </div>
          
          <h1 className="text-6xl md:text-8xl lg:text-[6rem] font-instrument text-zinc-900 tracking-tight mb-12 leading-[1.05]">
            Insights <br /><span className="font-instrument text-[#E0AAFF] italic">hub.</span>
          </h1>
          
          <p className="text-lg md:text-xl text-zinc-600 max-w-2xl mx-auto leading-relaxed italic border-l-2 border-zinc-200 pl-8 font-inter font-light">
      ...
      {posts.length > 0 && (
        <section className="py-20 px-6">
          <div className="container mx-auto max-w-6xl">
            <Link href={`/blog/${posts[0].slug}`} className="group block relative overflow-hidden rounded-[2.5rem] border border-white/5 bg-white/[0.01] hover:border-[#7B2CBF]/30 hover:bg-[#7B2CBF]/5 transition-colors duration-500 liquid-glass">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div className="aspect-[16/10] lg:aspect-auto relative overflow-hidden order-1 lg:order-2 bg-black/40 rounded-[2rem] m-6 liquid-glass">
                  <Image
                ...
                <div className="p-8 md:p-16 flex flex-col justify-center order-2 lg:order-1 font-inter">
                  ...
                  <h2 className="text-3xl md:text-5xl font-instrument text-zinc-900 tracking-tight leading-[1.05] mb-8 group-hover:text-[#E0AAFF] transition-all duration-500">
      ...
      {/* Blog Grid */}
      <section className="py-32 px-6 bg-white border-t border-white/5 relative overflow-hidden">
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20 border-b border-white/5 pb-12">
            <div className="max-w-xl">
              <h3 className="text-3xl md:text-4xl font-instrument text-zinc-900 tracking-tight uppercase mb-4">Latest Research</h3>
              <p className="text-zinc-500 font-inter font-light">Technological explorations in neural workflows, agentic reasoning, and scalable AI architectures.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {posts.slice(1).map((post, index) => (
              ...
              >
                <div>
                  <div className="relative mb-8 aspect-[16/10] overflow-hidden rounded-[1.5rem] border border-white/5 bg-black/40 liquid-glass">
                    <Image
                  ...
                  <div className="flex items-center justify-between mb-8 font-inter">
                    <span className="px-2.5 py-1 rounded-md bg-white/[0.01] text-[9px] font-semibold text-[#E0AAFF] border border-zinc-200 uppercase tracking-wider">
                  ...
                  <h3 className="text-2xl md:text-3xl font-semibold font-inter tracking-wide leading-snug mb-6 text-zinc-900 group-hover:text-[#E0AAFF] transition-colors">
                    {post.frontmatter.title}
                  </h3>
                  
                  <p className="text-zinc-500 text-sm font-inter font-light leading-relaxed mb-10 line-clamp-3">
                ...
                <div className="flex items-center justify-between pt-8 border-t border-white/5 font-inter">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-white/[0.02] border border-zinc-200 flex items-center justify-center font-bold text-[10px] text-zinc-900">
                  ...
                  <ChevronRight className="w-5 h-5 text-[#E0AAFF] group-hover:text-zinc-900 group-hover:translate-x-1 transition-all" />
                </div>
              </Link>
            ))}
          </div>
