    ...
    <>
      ...
      <main id="main-content" className="min-h-screen bg-[var(--background)] text-black selection:bg-[#7B2CBF]/20 selection:text-black pt-40 pb-24 font-inter">
        <div className="container mx-auto px-6 max-w-4xl relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-instrument text-black mb-8 tracking-tight">Privacy Policy</h1>
          ...
          <div className="prose prose-gray max-w-none font-inter font-light relative z-10 glass-card p-8 md:p-12 rounded-[2rem] border border-black/5 bg-[var(--muted)]">
            ...
            <section className="mb-8">
              ...
              <ul className="text-black list-disc pl-6 space-y-2 font-light">
            ...
            <section className="mb-8">
              ...
              <p className="text-black leading-relaxed">
                If you have any questions about this Privacy Policy, please get in touch with me at <span className="text-black font-medium">muhammadshadabshams@gmail.com</span> or <span className="text-black font-medium">info@aifloxium.online</span>
              </p>
            </section>
