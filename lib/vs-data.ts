...
export const vsData: Record<string, ComparisonData> = {
  ...
  'n8n-vs-make': {
    ...
    metaTitle: 'n8n vs Make: Visual Interface & Data Security',
  ...
  'voice-ai-vs-twilio-autodialer': {
    ...
    metaTitle: 'Voice AI vs Twilio: AI Agents vs Legacy IVR',
    metaDescription: 'Compare conversational Voice AI agents (Vapi & Retell + Claude 3.5) with legacy Twilio IVRs. Analyze latency, natural speech, and lead conversions.',
